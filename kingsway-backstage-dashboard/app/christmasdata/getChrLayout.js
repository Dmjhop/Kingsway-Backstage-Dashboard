...
export async function getChrLayout(currentService) {
  const res = await fetch(
    `https://api.planningcenteronline.com/services/v2/service_types/1301420/plans/${currentService.data[0].id}/attachments.data[0]`,
    requestOptions
  )
